	...
	<div class="container py-3">
		...
		<div class="card py-3">
			<div style="display: flex; justify-content: center;" class="py-3">
		        <button type="button" id="btnAgregarUsuarios" data-toggle="modal" data-target="#addUsuario" class="btn btn-primary btn-sm">	
		...
		<?php include 'content/modals/usuarios_modal.html'; ?>
	</div>
</body>
</html>
